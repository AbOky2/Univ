  ...
  return (
    <section className=" bg-white dark:bg-gray-900 dark:text-white">
      ...
      <div className="p-2 mt-4">
        <p className=" text-lg text-gray-600 dark:text-gray-200 font-sans font-medium text-opacity-90 mt-4">
          L'Université Hec Tchad délivre des diplômes nationaux contrôlés par
          l'Etat et la CAMES : BTS, Licence, Master.
        </p>
      </div>
      <div className="p-3">
        <div className=" rounded-xl border-1 shadow-md p-2 mb-3 h-16 flex justify-center bg-yellow-100">
        <Link href={"licence"}>
